...
function Results() {
  ...
  const items = [
    { before: "assets/about.jpeg", after: "assets/diferenciais.jpeg", name: "Marcos R.", desc: "8 meses · -14kg · ganho de massa magra" },
    { before: "assets/detalhes.jpeg", after: "assets/diferenciais.jpeg", name: "Pedro A.", desc: "5 meses · físico atlético · força +40%" },
    { before: "assets/about.jpeg", after: "assets/diferenciais.jpeg", name: "Carolina S.", desc: "6 meses · definição muscular · disciplina" },
  ];
  return (
